...
import logo from '../../assets/logo2_blanco.png';

import lo3dCamp from '../../assets/LogoHUB.png';
...
const Navbar = () => {
	...
	const countdownTimestampMs = 'Thu, 04 Dec 2025 19:00:00 GMT-5';
	...
	const [positionVar, setPositionVar] = useState(0);

	useEffect(() => {
		let mainPosition = window.scrollY;
		const handleScroll = () => {
			const currentPosition = window.scrollY;
			setPositionVar(currentPosition);
	...
	return (
		<nav
			...
			${positionVar != 0 ? 'blur-active' : null}
			${showNavbar ? null : 'show-var'}
			${courses ? 'course-active' : null}`}
			id='navbar'
		>
			<BannerTop />
			<div className='navbar-container container'>
				...
				<div className='academy'>
					...
					<a href='https://cursos.libel.academy/users/sign_in' rel='noreferrer' className='login'>
						Acceso a Campus
					</a>
					<div
				...
				>
					...
					<li className='menu-shortcuts'>
						...
						<a href='https://libel.academy/hub' className='menu-shortcuts-item'>
							HUB
						</a>
						<a
							href='https://libel.academy/licencias-character-creator-iclone'
					...
					<li className='menu-academy'>
						...
						<a href='https://cursos.libel.academy/users/sign_in' className='menu-log-in'>
							Acceso a Campus
						</a>
					</li>
				</ul>
						...
						<div className='courses-column'>
							...
							<ul>
								...
								<li>
									...
									<a href='https://cursos.libel.academy'>Cursos</a>
								</li>
								{/* <li>
                                    <div className="corses-bullet-point">
                                        <img
